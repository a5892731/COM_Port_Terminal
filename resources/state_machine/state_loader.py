...
from resources.state_machine.my_states import Initialization, CloseProgram, ReadSerialConfiguration, SerialConnect, \
                                              ReadSerialData, SendSerialData
...
class States():
    def __init__(self):
        ...
        self.com = SerialComPort()

        '''init all your states here
        this class stores memory of States'''
        self.Initialization = Initialization()
        self.CloseProgram = CloseProgram()
        self.ReadSerialConfiguration = ReadSerialConfiguration()
        self.SerialConnect = SerialConnect()
        self.ReadSerialData = ReadSerialData()
        self.SendSerialData = SendSerialData()

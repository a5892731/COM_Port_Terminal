...
def TestFrameData2_data_decode(self, frame):
    ...
    """
    try:
        self.variable6 = convert_bytes_to_variable(bytes = frame[0:2], data_type = "<H")
        self.variable7 = convert_bytes_to_variable(bytes = frame[2:4], data_type = "<h")
        self.variable8 = convert_bytes_to_variable(bytes = frame[4:12], data_type = "<d")
    except TypeError:
